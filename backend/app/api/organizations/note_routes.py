...
def list_notes(org_id, group_id):
    ...
    notes, total = get_notes_service(group_id, query_word, tag_names, folder_id, page, per_page)
...
def get_note(org_id, group_id, note_id):
    ...
    note = get_note_or_404_service(note_id, group_id)
...
def edit_note(org_id, group_id, note_id):
    ...
    note = get_note_or_404_service(note_id, group_id)
    note = update_note_service(note, data, group_id)
